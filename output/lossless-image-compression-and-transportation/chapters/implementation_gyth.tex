...
\[ \cite{hasanzadeh2005, Khaleel2014}
...
\[
P_i = \frac{1}{N} \sum_{k=1}^{N} \mu_{ik}. \cite{hasanzadeh2005}
\]
...
\[
v_i = \frac{\sum_{k=1}^{N} (\mu_{ik})^m z_k}{\sum_{k=1}^{N} (\mu_{ik})^m}. \cite{hasanzadeh2005, Khaleel2014}
\]
