...
\text{Block size} = 
\begin{cases} 
  32\times32 & \begin{aligned}[t]
                 &\text{if } \rho(B) < \theta_1 \\
                 &\text{(smooth region)}\end{aligned}\\[12pt]
  16\times16 & \begin{aligned}[t]
                 &\text{if } \theta_1 \le \rho(B) < \theta_2 \\
                 &\text{(moderate detail)}\end{aligned}\\[12pt]
  8\times8   & \begin{aligned}[t]
                 &\text{if } \rho(B) \ge \theta_2 \\
                 &\text{(high detail)}\end{aligned}
\end{cases}
\]
