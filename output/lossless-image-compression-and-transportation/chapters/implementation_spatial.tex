...
\subsection{Variable Block Size Compression with Adaptive Encoding}
...
\subparagraph{Run‑Length Encoding (RLE)} 
...
\subsubsection{Experimental Results on Lenna Image}
