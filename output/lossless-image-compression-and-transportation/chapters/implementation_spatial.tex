...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{jpegbasic.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{jpegbestpridict.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{jpegmodes.png}
