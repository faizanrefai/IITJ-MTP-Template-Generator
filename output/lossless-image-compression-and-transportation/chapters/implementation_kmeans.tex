...
\begin{itemize}
    ...
    \item $c_i$ is the number of points in cluster $i$, \cite{somasundarad2012}
    \item $\|x - v\|$ is the Euclidean distance.
\end{itemize}

The cluster centres are updated as the mean of all points assigned to that cluster\cite{somasundarad2012, Khaleel2014}:
...
\begin{itemize}
    ...
    \item \textbf{Objective function:} Exactly as was heavily expected, $J(V)$ is observed to decrease monotonically as the value of $K$ increases \cite{Khaleel2014}.
