...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{kmeans_algo.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{kmeans_compare.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{kmeans_compare_detail.png}
    \caption{K‑Means image compression: (a) original Lenna, (b)–(f) compressed with $K=2,4,8,16,32$, (g) error map for $K=16$, (h) colour palette, (i) cluster distribution.}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{kmeans_camera_compare.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1.0\textwidth]{kmeans_camera_compare_detail.png}
    \caption{K‑Means image compression: (a) original Cameraman, (b)–(f) compressed with $K=2,4,8,16,32$, (g) error map for $K=16$, (h) colour palette, (i) cluster distribution.}
